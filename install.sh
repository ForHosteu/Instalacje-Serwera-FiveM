...
wget https://runtime.fivem.net/artifacts/fivem/build_proot_linux/master/8633-3c5c9528f63c8aa202eae65309da473642d5604e/fx.tar.xz
tar xf fx.tar.xz
rm fx.tar.xz
...
while true; do
    read -p "Czy chcesz uruchomić serwer?" yn
    case $yn in
        [Yy]* ) bash /home/"$USER"/fivem/run.sh +exec server.cfg; break;;
        [Nn]* )echo "Miłego dnia"; exit;;
